...
> rather than inventing absent facts. Source prompts under `skills/<team>/agents/<name>.md` are authoritative for
...
**Constraints:** Phase 1 only. Do not begin literature search or synthesis. Source: `skills/deep-research/agents/research_question_agent.md`.
...
**Constraints:** Phase 1. Design only; do not collect or analyze data. Source: `skills/deep-research/agents/research_architect_agent.md`.
...
**Constraints:** Phase 2. Never upgrade a source's tier without evidence. Source: `skills/deep-research/agents/source_verification_agent.md`.
...
**Constraints:** Phase 2 only. Source: `skills/deep-research/agents/timeline_extraction_agent.md`.
...
**Constraints:** systematic-review mode. Emit `[REQUIRES CLARIFICATION]` for any absent statistic. Source: `skills/deep-research/agents/meta_analysis_agent.md`.
...
**Constraints:** systematic-review mode. Source: `skills/deep-research/agents/risk_of_bias_agent.md`.
...
**Constraints:** review mode. Decision must rest on specific evidence; no fabrication. Source: `skills/deep-research/agents/editor_in_chief_agent.md`.
...
**Constraints:** Checkpoints. CRITICAL findings are never silently dropped (Iron Rule 4). Source: `skills/deep-research/agents/devils_advocate_agent.md`.
...
**Constraints:** Advisory stop, not a hard block. Source: `skills/deep-research/agents/ethics_review_agent.md`.
...
**Constraints:** socratic mode. Do not produce the report for the user. Source: `skills/deep-research/agents/socratic_mentor_agent.md`.
...
**Constraints:** Phase 4/6. No frontmatter reads; locators mandatory. Source: `skills/deep-research/agents/report_compiler_agent.md`.
...
**Constraints:** Optional, post-pipeline. Source: `skills/deep-research/agents/monitoring_agent.md`.
...
**Constraints:** Phase 0. Source: `skills/academic-paper/agents/intake_agent.md`.
...
**Constraints:** Phase 1. No corpus mutation. Source: `skills/academic-paper/agents/literature_strategist_agent.md`.
...
**Constraints:** Phase 2. No drafting. Source: `skills/academic-paper/agents/structure_architect_agent.md`.
...
**Constraints:** Phase 3. Source: `skills/academic-paper/agents/argument_builder_agent.md`.
...
**Constraints:** Phase 4. Three-Layer Citation Emission; anti-leakage (session materials over model memory). Source: `skills/academic-paper/agents/draft_writer_agent.md`.
...
**Constraints:** Phase 5a. Verify existence via MCP indexes; flag `lookup_verified == false`. Source: `skills/academic-paper/agents/citation_compliance_agent.md`.
...
**Constraints:** Phase 5b (parallel with 5a). Source: `skills/academic-paper/agents/abstract_bilingual_agent.md`.
...
**Constraints:** Phase 6. READ-ONLY (Iron Rule 5). Source: `skills/academic-paper/agents/peer_reviewer_agent.md`.
...
**Constraints:** Phase 7. Refuse on no-locator / strict-policy citation failures. Source: `skills/academic-paper/agents/formatter_agent.md`.
...
**Constraints:** plan mode. Source: `skills/academic-paper/agents/socratic_mentor_agent.md`.
...
**Constraints:** Quantitative papers. Source: `skills/academic-paper/agents/visualization_agent.md`.
...
**Constraints:** revision-coach mode. Source: `skills/academic-paper/agents/revision_coach_agent.md`.
...
**Constraints:** Phase 0 (meta). Present config to user for confirmation. Source: `skills/academic-paper-reviewer/agents/field_analyst_agent.md`.
...
**Constraints:** Phase 1 (then Phase 2.5 coaching). Source: `skills/academic-paper-reviewer/agents/eic_agent.md`.
...
**Constraints:** Phase 1, Reviewer-1 slot only. Independent (Iron Rule 2). READ-ONLY. Source: `skills/academic-paper-reviewer/agents/methodology_reviewer_agent.md`.
...
**Constraints:** Phase 1, Reviewer-2 slot. Independent. READ-ONLY. Source: `skills/academic-paper-reviewer/agents/domain_reviewer_agent.md`.
...
**Constraints:** Phase 1, Reviewer-3 slot. Independent. READ-ONLY. Source: `skills/academic-paper-reviewer/agents/perspective_reviewer_agent.md`.
...
**Constraints:** Phase 1. CRITICAL findings block "Accept" (Iron Rule 4). READ-ONLY. Source: `skills/academic-paper-reviewer/agents/devils_advocate_reviewer_agent.md`.
...
**Constraints:** Phase 2. May read all reviewer outputs; MUST NOT fabricate (Iron Rule 3); preserves minority/DA findings. Source: `skills/academic-paper-reviewer/agents/editorial_synthesizer_agent.md`.
...
**Constraints:** Sole finalizer / policy evaluator. Resolves conflicts by severity + Iron Rules. Source: `skills/academic-pipeline/agents/pipeline_orchestrator_agent.md` + `.agents/docs/orchestration.md`.
...
**Constraints:** State only; no content production. Source: `skills/academic-pipeline/agents/state_tracker_agent.md`.
...
**Constraints:** Blocks pipeline on failure. Source: `skills/academic-pipeline/agents/integrity_verification_agent.md`.
...
**Constraints:** Feeds the formatter gate. Source: `skills/academic-pipeline/agents/claim_ref_alignment_audit_agent.md`.
...
**Constraints:** **Advisory only — NEVER blocks.** Source: `skills/academic-pipeline/agents/collaboration_depth_agent.md`.
...
**Constraints:** Hooks the integrity gates. Source: `skills/_shared/agents/compliance_agent.md`.
